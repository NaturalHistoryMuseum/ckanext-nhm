...
ABYSSLINE_UUIDS = [u'bc03fc1a-3613-41a2-b1f1-bf905e0fa6d0',
...
class ObjectController(toolkit.BaseController):
        ...
        if _format:
            ...
            try:
                ...
                if record:
                    ...
                    package = toolkit.get_action(u'package_show')(self.context,
                                                                  {u'id': package_id})
                    toolkit.redirect_to(
    ...
    def rdf(self, uuid, _format):
        ...
        '''
        data_dict = {
            u'uuid': uuid, u'format': _format,
            }

        toolkit.response.headers.update({u'Content-type': CONTENT_TYPES[_format]})
        try:
            return toolkit.get_action(u'object_rdf')(self.context, data_dict)
    ...
    def abyssline_object_redirect(self, uuid):
        ...
        search_result = toolkit.get_action(u'datastore_search')(context, {
            u'resource_id': resource_id, u'filters': {u'catalogNumber': uuid}
            })
        try:

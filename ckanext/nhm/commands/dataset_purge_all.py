...
class DatasetPurgeAllCommand(CkanCommand):
    ...
    def command(self):
        ...
        # Request confirmation from user as this could be very damaging
        confirmation = raw_input("This will purge all datasets from CKAN. Are you sure you want continue Y/N: ")

        if confirmation.lower() not in ['y', 'n']:
            raise ValueError('Do you want to purge datasets? Y or N')
